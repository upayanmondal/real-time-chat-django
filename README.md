...
1. User opens a chat room (`/chat/<room_id>/`)
2. JavaScript creates a WebSocket connection
3. Django Channels routes it via **ASGI**
4. `ChatConsumer`:

   * Connects user to a group
   * Receives messages
   * Broadcasts to all users in the room
5. Messages instantly appear for all connected users
